...
** Important:** If testing on a physical device, update `frontend/src/services/api.js`:
```js
...
-  **Doctor Matching** – Firestore-backed doctor DB with specialty filter
...
-  **Error Handling** – Graceful fallbacks on all API failures
